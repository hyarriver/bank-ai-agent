    ...
    <div className="markdown-content">
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => (
            <blockquote className="border-l-4 border-bank-blue pl-4 italic my-4">
              {children}
            </blockquote>
          ),
          table: ({ children }) => (
      ...
      {isStreaming && (
        <span className="inline-block w-2 h-4 bg-bank-blue animate-pulse ml-1" />
      )}
    </div>
  );
}
...
function AccountBalancePlugin({ data }) {
  return (
    <div className="bg-gradient-to-br from-bank-blue/5 to-bank-blue/10 border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        {data?.accounts?.map((account, index) => (
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <p className="text-xl font-medium text-bank-blue">
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
      ...
      <div className="space-y-4">
        <div className="flex justify-between">
          <span className="text-gray-600">从账户:</span>
          <span className="font-medium text-gray-900">
            {data?.fromAccount}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-600">到账户:</span>
          <span className="font-medium text-gray-900">
            {data?.toAccount}
          </span>
        </div>
        <div className="flex justify-between">
          ...
          <span className="font-medium text-lg text-bank-blue">
